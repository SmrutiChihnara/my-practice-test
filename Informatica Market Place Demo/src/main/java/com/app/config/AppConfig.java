...
import com.app.converter.WhUserTypeConverter;
 ...
 * @author Smruti
 * @version 1.0
 * @category : This is Spring Java Configuration <b>one time setup</b>
 */
...
@PropertySource("classpathx:app.properties") // load properties file from src/main/resource folder
public class AppConfig implements WebMvcConfigurer {
	// load properties into AppConfig
	@Autowired
	private Environment env;
	@Autowired
	private WhUserTypeConverter whconvert;
	...
	public LocalSessionFactoryBean sfObj() {
		...
		sf.setAnnotatedClasses(Uom.class, OrderMethod.class, ShipmentType.class, WhUserType.class, Item.class,
				PurchaseOrder.class);
	...
	public void addFormatters(FormatterRegistry registry) {
		registry.addConverter(whconvert);
	}
       @Bean
